...
describe('BscGateway::test-get-one-transaction', () => {
  const eth = BscGateway.getInstance();
...
describe('BscGateway::test-get-transaction-by-ids', () => {
  const eth = BscGateway.getInstance();
...
describe('BscGateway::test-get-one-block', () => {
  const eth = BscGateway.getInstance();
...
describe('BscGateway::test-get-block-count', () => {
  const eth = BscGateway.getInstance();
...
describe('BscGateway::test-get-block-transactions', () => {
  const eth = BscGateway.getInstance();
...
describe('BscGateway::test-get-multi-block-transactions', () => {
  const eth = BscGateway.getInstance();
...
describe('BscGateway::test-get-address-balance', () => {
  const eth = BscGateway.getInstance();
...
describe('BscGateway::test-get-transaction-status', () => {
  const eth = BscGateway.getInstance();
...
describe('BscGateway::createRawTransaction', () => {
  const gateway = BscGateway.getInstance();
...
describe('BscGateway::test-sign-raw-tx-by-singer-private-key', () => {
  const gateway = BscGateway.getInstance();
...
describe('BscGateway::test-send-raw-transaction', () => {
  const gateway = BscGateway.getInstance();
