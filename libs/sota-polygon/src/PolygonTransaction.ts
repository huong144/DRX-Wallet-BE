...
export class PolygonTransaction extends AccountBasedTransaction {
  ...
  constructor(
    ...
    const currency = CurrencyRegistry.getOneNativeCurrency(BlockchainPlatform.Polygon);
    const txProps = {
...
export default PolygonTransaction;
